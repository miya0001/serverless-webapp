...
module.exports.handler = (params, event, context) => {
  ...
  if (params.page && params.page.template && fileExists(path.join(templateRoot, params.page.template))) {
    result.statusCode = 200
    params.event = event
    result.body = render(params.page.template, params)
  } else if (fileExists(path.join(staticRoot, event.path))) {
